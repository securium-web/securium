...
RequiredFiles = (
    ...
    "tests/static/test_verify_build_policy.py",
    "scripts/real_patch_qualify.py",
    "scripts/verify_foundation_1b.py",
    "tests/static/test_real_patch_qualify.py",
    "tests/static/test_verify_foundation_1b.py",
    ...
    "scripts/verify_build_policy.py",
    ...
    "docs/BUILD_POLICY_VERIFICATION.md",
